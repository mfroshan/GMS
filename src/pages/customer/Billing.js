                ...
                {[...Array(noOfRows)].map((elementInArray, ind) => {
                  return (
                    <TableRow>
                      ...
                      <TableCell padding={0}>
                        <OutlinedInput type='number' id={`price${ind}`} endAdornment={<InputAdornment position="end">Rs</InputAdornment>} label="1" inputProps={{ min: 0, style: { textAlign: 'right' } }} onChange={(e) => { document.getElementById(`total${ind}`).value = document.getElementById(`qty${ind}`).value * e.target.value }} />
                      </TableCell>
                      <TableCell padding={0}>
                        <OutlinedInput disabled type='number' id={`total${ind}`} endAdornment={<InputAdornment position="end">Rs</InputAdornment>} label="1" inputProps={{ min: 0, style: { textAlign: 'right' } }} />
                      </TableCell>
                    </TableRow>
                  )
                })}
